export const HNavigate = () => {
    return(
        ...
        <div class="text-center pb-5">
            <a href="/purchase" class="btn btn-primary btn-lg active m-5 py-3 px-5" role="button" aria-pressed="true" style={{fontSize: "40px"}}>Browse</a>
            <a href="/owned" class="btn btn-primary btn-lg active m-5 py-3 px-5" role="button" aria-pressed="true" style={{fontSize: "40px"}}>Owned</a>
        </div>
